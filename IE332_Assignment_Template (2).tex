...
-	Replacing percentage of random pixels with either black or white noisy pixels
-	In control of what percentage of pixels are changed
-	Results in “sharp and sudden disturbances” that cause the image classifier to be thrown off. 
-	More successful when noise density increases 
-	Creates a challenge when attempting to detect image edges, segment pixels, extract certain features, or in this case, recognize an image. 
