...
The addition of salt and pepper noise can serve as a simple and somewhat effective black box attack. Otherwise known as “impulse noise”, salt and pepper noise adds scattered black and white pixels causing sharp disturbances in images. Research shows that proper adjustment of the parameters can result in a 100\% success rate of fooling a classifier with salt and pepper noise (Li, Xurong, et al., 2019).
